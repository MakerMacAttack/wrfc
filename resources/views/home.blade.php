...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <h3>About Us</h3>
        <p>As the oldest club in the DC area, the Washington Rugby Football Club (WRFC) has furthered the sport of Rugby since 1963 through our men's team, youth program and foundation.</p>
        <p>WRFC fields Division I and Division III 15s sides in the Fall and Spring, and Premier and Social 7s sides in the Summer. Practices are held in DC and are open to players of every experience level. For more information, visit our practice section and prospective player page.</p>
        <a>Click here for the full 2023 schedule.</a>
        <h3>SCHEDULE: PRACTICES, MATCHES & TOURNAMENTS</h3>
